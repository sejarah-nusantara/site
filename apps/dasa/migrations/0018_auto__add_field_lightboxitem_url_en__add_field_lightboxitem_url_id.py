...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LightBoxItem.url_en'
        db.add_column(u'dasa_lightboxitem', 'url_en',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'LightBoxItem.url_id'
        db.add_column(u'dasa_lightboxitem', 'url_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LightBoxItem.url_en'
        db.delete_column(u'dasa_lightboxitem', 'url_en')

        # Deleting field 'LightBoxItem.url_id'
        db.delete_column(u'dasa_lightboxitem', 'url_id')
