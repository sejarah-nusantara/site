...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CorpusDiplomaticumContract.dayTo'
        db.delete_column(u'dasa_corpusdiplomaticumcontract', 'dayTo')

        # Deleting field 'CorpusDiplomaticumContract.yearFrom'
        db.delete_column(u'dasa_corpusdiplomaticumcontract', 'yearFrom')

        # Deleting field 'CorpusDiplomaticumContract.monthFrom'
        db.delete_column(u'dasa_corpusdiplomaticumcontract', 'monthFrom')

        # Deleting field 'CorpusDiplomaticumContract.monthTo'
        db.delete_column(u'dasa_corpusdiplomaticumcontract', 'monthTo')

        # Deleting field 'CorpusDiplomaticumContract.yearTo'
        db.delete_column(u'dasa_corpusdiplomaticumcontract', 'yearTo')

        # Deleting field 'CorpusDiplomaticumContract.dayFrom'
        db.delete_column(u'dasa_corpusdiplomaticumcontract', 'dayFrom')


    def backwards(self, orm):
        # Adding field 'CorpusDiplomaticumContract.dayTo'
        db.add_column(u'dasa_corpusdiplomaticumcontract', 'dayTo',
                      self.gf('django.db.models.fields.CharField')(default=2, max_length=255, db_index=True),
                      keep_default=False)

        # Adding field 'CorpusDiplomaticumContract.yearFrom'
        db.add_column(u'dasa_corpusdiplomaticumcontract', 'yearFrom',
                      self.gf('django.db.models.fields.CharField')(default=2, max_length=255, db_index=True),
                      keep_default=False)

        # Adding field 'CorpusDiplomaticumContract.monthFrom'
        db.add_column(u'dasa_corpusdiplomaticumcontract', 'monthFrom',
                      self.gf('django.db.models.fields.CharField')(default=2, max_length=255, db_index=True),
                      keep_default=False)

        # Adding field 'CorpusDiplomaticumContract.monthTo'
        db.add_column(u'dasa_corpusdiplomaticumcontract', 'monthTo',
                      self.gf('django.db.models.fields.CharField')(default=2, max_length=255, db_index=True),
                      keep_default=False)

        # Adding field 'CorpusDiplomaticumContract.yearTo'
        db.add_column(u'dasa_corpusdiplomaticumcontract', 'yearTo',
                      self.gf('django.db.models.fields.CharField')(default=2, max_length=255, db_index=True),
                      keep_default=False)

        # Adding field 'CorpusDiplomaticumContract.dayFrom'
        db.add_column(u'dasa_corpusdiplomaticumcontract', 'dayFrom',
                      self.gf('django.db.models.fields.CharField')(default=2, max_length=255, db_index=True),
                      keep_default=False)
