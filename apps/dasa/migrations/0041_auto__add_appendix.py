...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Appendix'
        db.create_table('dasa_appendix', (
            ...
            ('folio_number_extra', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('document_type_nl', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('title_nl', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('doc_y', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('doc_m', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('doc_d', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('res_y', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('res_m', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('res_d', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('vessel_names', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('notes', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'dasa', ['Appendix'])


    def backwards(self, orm):
        # Deleting model 'Appendix'
        db.delete_table('dasa_appendix')
    ...
    models = {
        ...
        u'dasa.appendix': {
            ...
            'document_type_nl': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
        ...
        u'dasa.news': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 12, 21, 0, 0)'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'description_en': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'description_id': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
