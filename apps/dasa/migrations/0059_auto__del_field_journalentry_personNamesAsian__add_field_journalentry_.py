...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'JournalEntry.personNamesAsian'
        db.delete_column(u'dasa_journalentry', 'personNamesAsian')

        # Adding field 'JournalEntry.person_names_asian'
        db.add_column(u'dasa_journalentry', 'person_names_asian',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'JournalEntry.person_names_european'
        db.add_column(u'dasa_journalentry', 'person_names_european',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'JournalEntry.place_names'
        db.add_column(u'dasa_journalentry', 'place_names',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'JournalEntry.personNamesAsian'
        db.add_column(u'dasa_journalentry', 'personNamesAsian',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Deleting field 'JournalEntry.person_names_asian'
        db.delete_column(u'dasa_journalentry', 'person_names_asian')

        # Deleting field 'JournalEntry.person_names_european'
        db.delete_column(u'dasa_journalentry', 'person_names_european')

        # Deleting field 'JournalEntry.place_names'
        db.delete_column(u'dasa_journalentry', 'place_names')
    ...
    models = {
        ...
        u'dasa.marginaliapersonnamesasian': {
            'Meta': {'object_name': 'MarginaliaPersonNamesAsian'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'dasa.news': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2017, 9, 20, 0, 0)'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'description_en': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'description_id': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
