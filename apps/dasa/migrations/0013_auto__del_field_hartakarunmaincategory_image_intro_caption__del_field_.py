...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HartaKarunMainCategory.image_description_caption_en'
        db.add_column('dasa_hartakarunmaincategory', 'image_description_caption_en',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HartaKarunMainCategory.image_description_caption_id'
        db.add_column('dasa_hartakarunmaincategory', 'image_description_caption_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'HartaKarunMainCategory.image_description_caption_en'
        db.delete_column('dasa_hartakarunmaincategory', 'image_description_caption_en')

        # Deleting field 'HartaKarunMainCategory.image_description_caption_id'
        db.delete_column('dasa_hartakarunmaincategory', 'image_description_caption_id')
