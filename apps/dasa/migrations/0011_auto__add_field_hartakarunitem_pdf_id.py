...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HartaKarunItem.pdf_id'
        db.add_column('dasa_hartakarunitem', 'pdf_id',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'HartaKarunItem.pdf_id'
        db.delete_column('dasa_hartakarunitem', 'pdf_id')
