...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Appendix.title_nl'
        db.alter_column('dasa_appendix', 'title_nl', self.gf('django.db.models.fields.TextField')(max_length=255))

        # Changing field 'Appendix.document_type_nl'
        db.alter_column('dasa_appendix', 'document_type_nl', self.gf('django.db.models.fields.TextField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Appendix.title_nl'
        db.alter_column('dasa_appendix', 'title_nl', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Appendix.document_type_nl'
        db.alter_column('dasa_appendix', 'document_type_nl', self.gf('django.db.models.fields.CharField')(max_length=255))
