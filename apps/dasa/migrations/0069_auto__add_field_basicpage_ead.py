...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BasicPage.ead'
        db.add_column(u'dasa_basicpage', 'ead',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BasicPage.ead'
        db.delete_column(u'dasa_basicpage', 'ead')
    ...
    models = {
        ...
        u'dasa.basicpage': {
            ...
            'ead': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
