...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CorpusDiplomaticumContract'
        db.create_table(u'dasa_corpusdiplomaticumcontract', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('volumeNumber', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('pageFrom', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('pageTo', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('pageSupp', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('NumberRoman', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('NumberDigits', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('areaName', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('dayFrom', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('monthFrom', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('yearFrom', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('dayTo', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('monthTo', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('yearTo', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('kingdomName', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('contractSourceDescription', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('signedPlace', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('signedAsians', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('signedEuropeans', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'dasa', ['CorpusDiplomaticumContract'])


    def backwards(self, orm):
        # Deleting model 'CorpusDiplomaticumContract'
        db.delete_table(u'dasa_corpusdiplomaticumcontract')
    ...
    models = {
        ...
        u'dasa.corpusdiplomaticumcontract': {
            ...
            'contractSourceDescription': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            ...
            'pageFrom': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
            'pageSupp': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'pageTo': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'signedAsians': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'signedEuropeans': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
        ...
        u'dasa.news': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2017, 3, 15, 0, 0)'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'description_en': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'description_id': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
