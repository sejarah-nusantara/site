...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CorpusDiplomaticumContract.order'
        db.add_column(u'dasa_corpusdiplomaticumcontract', 'order',
                      self.gf('django.db.models.fields.IntegerField')(default=1, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CorpusDiplomaticumContract.order'
        db.delete_column(u'dasa_corpusdiplomaticumcontract', 'order')
    ...
    models = {
        ...
        u'dasa.news': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2017, 3, 22, 0, 0)'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'description_en': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'description_id': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
