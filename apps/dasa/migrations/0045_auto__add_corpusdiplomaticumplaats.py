...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CorpusDiplomaticumPlaats'
        db.create_table(u'dasa_corpusdiplomaticumplaats', (
        ...
        db.send_create_signal(u'dasa', ['CorpusDiplomaticumPlaats'])


    def backwards(self, orm):
        # Deleting model 'CorpusDiplomaticumPlaats'
        db.delete_table(u'dasa_corpusdiplomaticumplaats')
