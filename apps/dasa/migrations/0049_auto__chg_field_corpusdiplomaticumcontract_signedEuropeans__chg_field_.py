...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CorpusDiplomaticumContract.signedEuropeans'
        db.alter_column(u'dasa_corpusdiplomaticumcontract', 'signedEuropeans', self.gf('django.db.models.fields.TextField')())

        # Changing field 'CorpusDiplomaticumContract.signedAsians'
        db.alter_column(u'dasa_corpusdiplomaticumcontract', 'signedAsians', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'CorpusDiplomaticumContract.signedEuropeans'
        db.alter_column(u'dasa_corpusdiplomaticumcontract', 'signedEuropeans', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'CorpusDiplomaticumContract.signedAsians'
        db.alter_column(u'dasa_corpusdiplomaticumcontract', 'signedAsians', self.gf('django.db.models.fields.CharField')(max_length=255))
