...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HartaKarunItem.number'
        db.add_column('dasa_hartakarunitem', 'number',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'HartaKarunItem.number'
        db.delete_column('dasa_hartakarunitem', 'number')
    ...
    models = {
        ...
        'dasa.news': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 5, 0, 0)'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'description_en': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'description_id': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
