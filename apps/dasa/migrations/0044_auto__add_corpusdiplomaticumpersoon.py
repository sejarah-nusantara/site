...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CorpusDiplomaticumPersoon'
        db.create_table(u'dasa_corpusdiplomaticumpersoon', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('ref', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('volumePage', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal(u'dasa', ['CorpusDiplomaticumPersoon'])


    def backwards(self, orm):
        # Deleting model 'CorpusDiplomaticumPersoon'
        db.delete_table(u'dasa_corpusdiplomaticumpersoon')
