...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MenuItem.order'
        db.alter_column(u'dasa_menuitem', 'order', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'MenuItem.order'
        db.alter_column(u'dasa_menuitem', 'order', self.gf('django.db.models.fields.IntegerField')(default=1))
