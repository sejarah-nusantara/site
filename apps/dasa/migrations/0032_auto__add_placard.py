...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Placard'
        db.create_table(u'dasa_placard', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('volume_number', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('page_number_from', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('page_number_to', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('governor', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('issued_date_d', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('issued_date_m', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('issued_date_y', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('published_date_d', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('published_date_m', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('published_date_y', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('text', self.gf('django.db.models.fields.TextField')()),
            ('next', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='previous', null=True, to=orm['dasa.Placard'])),
            ('order', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'dasa', ['Placard'])


    def backwards(self, orm):
        # Deleting model 'Placard'
        db.delete_table(u'dasa_placard')
    ...
    models = {
        ...
        u'dasa.news': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 1, 22, 0, 0)'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'description_en': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'description_id': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
