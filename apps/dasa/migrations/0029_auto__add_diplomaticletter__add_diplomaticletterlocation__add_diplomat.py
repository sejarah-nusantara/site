...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DiplomaticLetter'
        db.create_table(u'dasa_diplomaticletter', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('archiveFile', self.gf('django.db.models.fields.TextField')(blank=True)),
            ...
            ('insertion_y', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('insertion_m', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('insertion_d', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('insertion_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('original_y', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('original_m', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('original_d', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('notes', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('order', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('next', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='previous', null=True, to=orm['dasa.DiplomaticLetter'])),
        ))
        db.send_create_signal(u'dasa', ['DiplomaticLetter'])
        ...
        # Adding model 'DiplomaticLetterLocation'
        db.create_table(u'dasa_diplomaticletterlocation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('continent', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('region', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('region_altenative_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('city', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('city_alternative_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('exact', self.gf('django.db.models.fields.CharField')(max_length=1, null=True)),
            ('place', self.gf('django.db.models.fields.TextField')(null=True)),
            ('reference', self.gf('django.db.models.fields.TextField')(null=True)),
        ...
        db.send_create_signal(u'dasa', ['DiplomaticLetterLocation'])

        # Adding model 'DiplomaticLetterRuler'
        db.create_table(u'dasa_diplomaticletterruler', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name_modern', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('period_start', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('period_end', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('location', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('alternative_name1', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('alternative_name2', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('alternative_name3', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('alternative_name4', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('alternative_name5', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('alternative_name6', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('alternative_name7', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('alternative_name8', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('reference', self.gf('django.db.models.fields.TextField')(null=True)),
        ))
        db.send_create_signal(u'dasa', ['DiplomaticLetterRuler'])


    def backwards(self, orm):
        # Deleting model 'DiplomaticLetter'
        db.delete_table(u'dasa_diplomaticletter')
        ...
        # Deleting model 'DiplomaticLetterLocation'
        db.delete_table(u'dasa_diplomaticletterlocation')

        # Deleting model 'DiplomaticLetterRuler'
        db.delete_table(u'dasa_diplomaticletterruler')
