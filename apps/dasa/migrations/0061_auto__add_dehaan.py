...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DeHaan'
        db.create_table(u'dasa_dehaan', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('originalMissingYN', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('scanMissingYN', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('refScanFrontImage', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('refScanBackImage', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('descriptionByDeHaanNL', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('descriptionOnMapNL', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('titleNL', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('titleEN', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('typeMap', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('scale', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('locationEN', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('dimensionHWinCM', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('Color', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('typeGraphics', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('Blurred', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('maker', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('date', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('commentsEN', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('refOtherMaps', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('refOriginalEN', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('refArchiveFile', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('refArchiveDateBijlagen', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('refArchiveDescription', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('indexTerms', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('numIndexTerms', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'dasa', ['DeHaan'])


    def backwards(self, orm):
        # Deleting model 'DeHaan'
        db.delete_table(u'dasa_dehaan')
