...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'JournalEntry.file_id'
        db.delete_column('dasa_journalentry', 'file_id')

        # Deleting field 'JournalEntry.fonds'
        db.delete_column('dasa_journalentry', 'fonds')

        # Deleting field 'JournalEntry.institution'
        db.delete_column('dasa_journalentry', 'institution')

        # Adding field 'JournalEntry.archiveFile'
        db.add_column('dasa_journalentry', 'archiveFile',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'JournalEntry.file_id'
        db.add_column('dasa_journalentry', 'file_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'JournalEntry.fonds'
        db.add_column('dasa_journalentry', 'fonds',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'JournalEntry.institution'
        db.add_column('dasa_journalentry', 'institution',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Deleting field 'JournalEntry.archiveFile'
        db.delete_column('dasa_journalentry', 'archiveFile')
    ...
    models = {
        ...
        'dasa.news': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 2, 27, 0, 0)'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'description_en': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'description_id': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
