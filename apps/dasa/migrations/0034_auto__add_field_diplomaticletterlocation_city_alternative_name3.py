...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DiplomaticLetterLocation.city_alternative_name3'
        db.add_column(u'dasa_diplomaticletterlocation', 'city_alternative_name3',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DiplomaticLetterLocation.city_alternative_name3'
        db.delete_column(u'dasa_diplomaticletterlocation', 'city_alternative_name3')
