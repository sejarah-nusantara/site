...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'MenuItem', fields ['order']
        db.create_unique(u'dasa_menuitem', ['order'])


    def backwards(self, orm):
        # Removing unique constraint on 'MenuItem', fields ['order']
        db.delete_unique(u'dasa_menuitem', ['order'])
    ...
    models = {
        ...
        u'dasa.menuitem': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.IntegerField', [], {'unique': 'True', 'blank': 'True'}),
