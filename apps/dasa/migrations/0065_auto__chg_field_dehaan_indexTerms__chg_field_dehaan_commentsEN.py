...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DeHaan.indexTerms'
        db.alter_column(u'dasa_dehaan', 'indexTerms', self.gf('django.db.models.fields.CharField')(max_length=1000))

        # Changing field 'DeHaan.commentsEN'
        db.alter_column(u'dasa_dehaan', 'commentsEN', self.gf('django.db.models.fields.CharField')(max_length=1000))

    def backwards(self, orm):

        # Changing field 'DeHaan.indexTerms'
        db.alter_column(u'dasa_dehaan', 'indexTerms', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'DeHaan.commentsEN'
        db.alter_column(u'dasa_dehaan', 'commentsEN', self.gf('django.db.models.fields.CharField')(max_length=255))
