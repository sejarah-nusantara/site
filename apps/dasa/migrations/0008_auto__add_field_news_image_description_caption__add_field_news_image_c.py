...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'News.image_description_caption'
        db.add_column('dasa_news', 'image_description_caption',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'News.image_caption'
        db.add_column('dasa_news', 'image_caption',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Scan.image_caption'
        db.add_column('dasa_scan', 'image_caption',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HartaKarunMainCategory.image_intro_caption'
        db.add_column('dasa_hartakarunmaincategory', 'image_intro_caption',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HartaKarunMainCategory.image_caption'
        db.add_column('dasa_hartakarunmaincategory', 'image_caption',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BasicPage.image_description_caption'
        db.add_column('dasa_basicpage', 'image_description_caption',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BasicPage.image_caption'
        db.add_column('dasa_basicpage', 'image_caption',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HartaKarunItem.image_caption'
        db.add_column('dasa_hartakarunitem', 'image_caption',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HartaKarunCategory.image_intro_caption'
        db.add_column('dasa_hartakaruncategory', 'image_intro_caption',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HartaKarunCategory.image_caption'
        db.add_column('dasa_hartakaruncategory', 'image_caption',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'News.image_description_caption'
        db.delete_column('dasa_news', 'image_description_caption')

        # Deleting field 'News.image_caption'
        db.delete_column('dasa_news', 'image_caption')

        # Deleting field 'Scan.image_caption'
        db.delete_column('dasa_scan', 'image_caption')

        # Deleting field 'HartaKarunMainCategory.image_intro_caption'
        db.delete_column('dasa_hartakarunmaincategory', 'image_intro_caption')

        # Deleting field 'HartaKarunMainCategory.image_caption'
        db.delete_column('dasa_hartakarunmaincategory', 'image_caption')

        # Deleting field 'BasicPage.image_description_caption'
        db.delete_column('dasa_basicpage', 'image_description_caption')

        # Deleting field 'BasicPage.image_caption'
        db.delete_column('dasa_basicpage', 'image_caption')

        # Deleting field 'HartaKarunItem.image_caption'
        db.delete_column('dasa_hartakarunitem', 'image_caption')

        # Deleting field 'HartaKarunCategory.image_intro_caption'
        db.delete_column('dasa_hartakaruncategory', 'image_intro_caption')

        # Deleting field 'HartaKarunCategory.image_caption'
        db.delete_column('dasa_hartakaruncategory', 'image_caption')
    ...
    models = {
        ...
        'dasa.news': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 5, 3, 0, 0)'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'description_en': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'description_id': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
