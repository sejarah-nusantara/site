...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'News.image_description_caption_en'
        db.add_column('dasa_news', 'image_description_caption_en',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'News.image_description_caption_id'
        db.add_column('dasa_news', 'image_description_caption_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'News.image_caption_en'
        db.add_column('dasa_news', 'image_caption_en',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'News.image_caption_id'
        db.add_column('dasa_news', 'image_caption_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HartaKarunMainCategory.image_intro_caption_en'
        db.add_column('dasa_hartakarunmaincategory', 'image_intro_caption_en',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HartaKarunMainCategory.image_intro_caption_id'
        db.add_column('dasa_hartakarunmaincategory', 'image_intro_caption_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HartaKarunMainCategory.image_caption_en'
        db.add_column('dasa_hartakarunmaincategory', 'image_caption_en',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HartaKarunMainCategory.image_caption_id'
        db.add_column('dasa_hartakarunmaincategory', 'image_caption_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BasicPage.image_description_caption_en'
        db.add_column('dasa_basicpage', 'image_description_caption_en',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BasicPage.image_description_caption_id'
        db.add_column('dasa_basicpage', 'image_description_caption_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BasicPage.image_caption_en'
        db.add_column('dasa_basicpage', 'image_caption_en',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BasicPage.image_caption_id'
        db.add_column('dasa_basicpage', 'image_caption_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HartaKarunItem.image_caption_en'
        db.add_column('dasa_hartakarunitem', 'image_caption_en',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HartaKarunItem.image_caption_id'
        db.add_column('dasa_hartakarunitem', 'image_caption_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HartaKarunCategory.image_intro_caption_en'
        db.add_column('dasa_hartakaruncategory', 'image_intro_caption_en',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HartaKarunCategory.image_intro_caption_id'
        db.add_column('dasa_hartakaruncategory', 'image_intro_caption_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HartaKarunCategory.image_caption_en'
        db.add_column('dasa_hartakaruncategory', 'image_caption_en',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HartaKarunCategory.image_caption_id'
        db.add_column('dasa_hartakaruncategory', 'image_caption_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'News.image_description_caption_en'
        db.delete_column('dasa_news', 'image_description_caption_en')

        # Deleting field 'News.image_description_caption_id'
        db.delete_column('dasa_news', 'image_description_caption_id')

        # Deleting field 'News.image_caption_en'
        db.delete_column('dasa_news', 'image_caption_en')

        # Deleting field 'News.image_caption_id'
        db.delete_column('dasa_news', 'image_caption_id')

        # Deleting field 'HartaKarunMainCategory.image_intro_caption_en'
        db.delete_column('dasa_hartakarunmaincategory', 'image_intro_caption_en')

        # Deleting field 'HartaKarunMainCategory.image_intro_caption_id'
        db.delete_column('dasa_hartakarunmaincategory', 'image_intro_caption_id')

        # Deleting field 'HartaKarunMainCategory.image_caption_en'
        db.delete_column('dasa_hartakarunmaincategory', 'image_caption_en')

        # Deleting field 'HartaKarunMainCategory.image_caption_id'
        db.delete_column('dasa_hartakarunmaincategory', 'image_caption_id')

        # Deleting field 'BasicPage.image_description_caption_en'
        db.delete_column('dasa_basicpage', 'image_description_caption_en')

        # Deleting field 'BasicPage.image_description_caption_id'
        db.delete_column('dasa_basicpage', 'image_description_caption_id')

        # Deleting field 'BasicPage.image_caption_en'
        db.delete_column('dasa_basicpage', 'image_caption_en')

        # Deleting field 'BasicPage.image_caption_id'
        db.delete_column('dasa_basicpage', 'image_caption_id')

        # Deleting field 'HartaKarunItem.image_caption_en'
        db.delete_column('dasa_hartakarunitem', 'image_caption_en')

        # Deleting field 'HartaKarunItem.image_caption_id'
        db.delete_column('dasa_hartakarunitem', 'image_caption_id')

        # Deleting field 'HartaKarunCategory.image_intro_caption_en'
        db.delete_column('dasa_hartakaruncategory', 'image_intro_caption_en')

        # Deleting field 'HartaKarunCategory.image_intro_caption_id'
        db.delete_column('dasa_hartakaruncategory', 'image_intro_caption_id')

        # Deleting field 'HartaKarunCategory.image_caption_en'
        db.delete_column('dasa_hartakaruncategory', 'image_caption_en')

        # Deleting field 'HartaKarunCategory.image_caption_id'
        db.delete_column('dasa_hartakaruncategory', 'image_caption_id')
    ...
    models = {
        ...
        'dasa.hartakaruncategory': {
            ...
            'image_intro_caption_en': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'image_intro_caption_id': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
