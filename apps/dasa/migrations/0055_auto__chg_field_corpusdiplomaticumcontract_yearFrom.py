...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CorpusDiplomaticumContract.yearFrom'
        db.alter_column(u'dasa_corpusdiplomaticumcontract', 'yearFrom', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'CorpusDiplomaticumContract.yearFrom'
        db.alter_column(u'dasa_corpusdiplomaticumcontract', 'yearFrom', self.gf('django.db.models.fields.IntegerField')(default=2))
    ...
    models = {
        ...
        u'dasa.corpusdiplomaticumcontract': {
            ...
            'yearFrom': ('django.db.models.fields.IntegerField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
