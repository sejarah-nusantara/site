...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CorpusDiplomaticumContract.pageFrom'
        db.alter_column(u'dasa_corpusdiplomaticumcontract', 'pageFrom', self.gf('django.db.models.fields.CharField')(default=1, max_length=255))

    def backwards(self, orm):

        # Changing field 'CorpusDiplomaticumContract.pageFrom'
        db.alter_column(u'dasa_corpusdiplomaticumcontract', 'pageFrom', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
