...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DeHaan.IDSource'
        db.alter_column(u'dasa_dehaan', 'IDSource', self.gf('django.db.models.fields.CharField')(max_length=6))

    def backwards(self, orm):

        # Changing field 'DeHaan.IDSource'
        db.alter_column(u'dasa_dehaan', 'IDSource', self.gf('django.db.models.fields.CharField')(max_length=4))
