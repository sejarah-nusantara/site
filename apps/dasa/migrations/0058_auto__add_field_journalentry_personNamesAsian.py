...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing M2M table for field personNamesAsian on 'JournalEntry'
        db.delete_table(db.shorten_name(u'dasa_journalentry_personNamesAsian'))
    ...
    def backwards(self, orm):
        ...
        # Adding M2M table for field personNamesAsian on 'JournalEntry'
        m2m_table_name = db.shorten_name(u'dasa_journalentry_personNamesAsian')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('journalentry', models.ForeignKey(orm[u'dasa.journalentry'], null=False)),
            ('marginaliapersonnamesasian', models.ForeignKey(orm[u'dasa.marginaliapersonnamesasian'], null=False))
        ))
        db.create_unique(m2m_table_name, ['journalentry_id', 'marginaliapersonnamesasian_id'])
    ...
    models = {
        ...
        u'dasa.journalentry': {
            ...
            'order': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'personNamesAsian': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
