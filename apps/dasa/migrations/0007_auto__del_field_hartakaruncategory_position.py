...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'HartaKarunCategory.position'
        db.delete_column('dasa_hartakaruncategory', 'position')

    def backwards(self, orm):
        # Adding field 'HartaKarunCategory.position'
        db.add_column('dasa_hartakaruncategory', 'position',
    ...
    models = {
        ...
        'dasa.news': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 27, 0, 0)'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'description_en': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'description_id': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
